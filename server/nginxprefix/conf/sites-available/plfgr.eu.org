...
server {
	...
	location ~ "/server_function/special_phab_domain_handle/(.*)" {
		...
		proxy_http_version 1.1;
		proxy_set_header Connection "keep-alive";
		proxy_pass http://unix:server/nginxprefix/servers/phabricator:/$request_path$is_args$args;
		proxy_set_header Nginx-Loopback true;
		proxy_read_timeout 999999;
		proxy_send_timeout 999999;
		proxy_set_header Host $http_host;
	...
	location ~ "/server_function/special_cloud_domain_handle/(.*)" {
		...
		proxy_http_version 1.1;
		proxy_set_header Connection "keep-alive";
		proxy_pass http://unix:server/nginxprefix/servers/ownCloud:/$request_path$is_args$args;
		proxy_set_header Nginx-Loopback true;
		proxy_read_timeout 999999;
		proxy_send_timeout 999999;
		proxy_set_header Host $http_host;
	...
	location ~ "/server_function/special_social_domain_handle/(.*)" {
		...
		proxy_http_version 1.1;
		proxy_set_header Connection "keep-alive";
		proxy_pass http://unix:server/nginxprefix/servers/gnusocial:/$request_path$is_args$args;
		proxy_set_header Nginx-Loopback true;
		proxy_read_timeout 999999;
		proxy_send_timeout 999999;
		proxy_set_header Host $http_host;
